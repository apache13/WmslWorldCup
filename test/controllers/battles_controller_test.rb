...
class BattlesControllerTest < ActionController::TestCase
  ...
  test "should create battle" do
    assert_difference('Battle.count') do
      post :create, battle: { match_id: @battle.match_id, player1_id: @battle.player1_id, player1_point: @battle.player1_point, player2_id: @battle.player2_id, player2_point: @battle.player2_point }
    end
  ...
  test "should update battle" do
    patch :update, id: @battle, battle: { match_id: @battle.match_id, player1_id: @battle.player1_id, player1_point: @battle.player1_point, player2_id: @battle.player2_id, player2_point: @battle.player2_point }
    assert_redirected_to battle_path(assigns(:battle))
  end
