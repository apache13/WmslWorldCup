...
class BetsControllerTest < ActionController::TestCase
  ...
  test "should create bet" do
    assert_difference('Bet.count') do
      post :create, bet: { match_id: @bet.match_id, team1_score: @bet.team1_score, team2_score: @bet.team2_score }
    end
  ...
  test "should update bet" do
    patch :update, id: @bet, bet: { match_id: @bet.match_id, team1_score: @bet.team1_score, team2_score: @bet.team2_score }
    assert_redirected_to bet_path(assigns(:bet))
  end
